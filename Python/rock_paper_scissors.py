...
while True:
    ...
    # Display the recognized gesture on the camera screen
    cv2.putText(img, recognized_gesture, (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
    ...
    if lmList and lmList[8][1] in range(10, 160) and lmList[8][2] in range(100, 150):
        recognized_gesture = ""  # Clear the gesture

    # Determine the computer's choice randomly
    computer_choice = random.choice(game_options)

    # If the player has made a gesture, determine the winner
    if recognized_gesture in game_options:
        winner = determine_winner(recognized_gesture, computer_choice)
        cv2.putText(img, f"Computer: {computer_choice}", (10, 200), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
        cv2.putText(img, winner, (10, 250), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
